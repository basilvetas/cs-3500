    ...
    public partial class SpreadsheetForm : Form
    {
        ...
        private void closeMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {   // referenced StackOverflow for DialogResult syntax
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    if (saveCanceled)   // if they canceled the save then don't close
                        return; 
                }                    
                else if (result == DialogResult.Cancel)
                    return;

                // tells the 'closing' method that is came from 'close' method rather than X
        ...
        private void helpMenu_Click(object sender, EventArgs e)
        {
            MessageBox.Show(
                ...
                "or formulas into the spreadsheet using the F(x) text box. To change selections, " +  
                "the user must click the target cell with their mouse. A cell's content must be" +
