...
// Wherever I launch my form, change the automatically generated code with:
// ApplicationUnderTest.Launch(@"..\..\..\SpreadsheetGUI\bin\debug\SpreadsheetGUI.exe");
// This should be the final step of CodedUI tests - don't do this then create more tests

** How do I check if a file already existed to ask user if they want to overwrite?
