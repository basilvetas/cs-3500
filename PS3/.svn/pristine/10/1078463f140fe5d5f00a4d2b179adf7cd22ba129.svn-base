...
namespace FormulaTester
{
    ...
    public class FormulaTester
    {
        ...
        public void Test7()
        {
            Formula f = new Formula("(_6 / (3 - 3))", x => x.ToUpper(), x => true);
        ...
        /// <summary>
        /// Tests for bad format
        /// </summary>
        [TestMethod()]
        [ExpectedException(typeof(FormulaFormatException))]
        public void Test34()
        {
            Formula formula_tester = new Formula("A1 + 1A + A1", x => x, x => true);
        }
        ...
        public void Test36()
        {
            ...
            Formula g = new Formula("x+z", s => s.ToUpper(), s => true);
            List<String> a = new List<String>(f.GetVariables());
            List<String> b = new List<String>(g.GetVariables());
            Assert.AreEqual(a.ToString(),b.ToString());
        }        

        // still need to test GetVariables
    }
}
